...
if !abuild_nolibs! == false (
    ...
    REM ... and added:
	set abuild_include_paths=-I"!arduino_path!\hardware\arduino\avr\variants\standard"
...
REM     with user-configured environment variables for all settings.ARDUINO_BURNRATE
REM
